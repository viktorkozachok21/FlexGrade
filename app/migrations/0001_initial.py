    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Departmant')),
            ],
        ),
        migrations.CreateModel(
            name='School',
            fields=[
                ('code', models.UUIDField(default='093c', editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('code', models.UUIDField(default='4fb2978427', editable=False, primary_key=True, serialize=False)),
